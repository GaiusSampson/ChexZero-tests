...
def compute_f1_mcc(X_test_dir, y_test_dir, X_val_dir, y_val_dir, model_path, alt_labels_dict : dict = None, find_best_alt: bool = True, thresh_func: Callable = matthews_corrcoef): 
    ...
    * find_best_alt : bool
    ...
    VAL_GROUNDTRUTH_PATH = "./test_data/val.csv"
    GROUNDTRUTH_PATH = "./test_data/groundtruth.csv"
    ...
    val_X = "./test_data/chexpert_val.h5"
    val_y = "./test_data/val.csv"
    
    # dir for test datasets
    test_X = "./test_data/chexpert_test.h5"
    test_y = "./test_data/groundtruth.csv"
    
    if alt_labels_dict is not None and find_best_alt: 
        # find best alternate labels
        val_res, val_pred = evaluate_model(val_X, val_y, model_path, alt_labels_dict=alt_labels_dict)
    ...
    # get best thresholds
    best_p_vals = get_best_p_vals(val_pred, val_groundtruth, alt_labels_list, metric_func=thresh_func)
